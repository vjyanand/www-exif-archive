...
var wasmImports = {
  ...
  /** @export */ s: ___syscall_renameat,
  /** @export */ t: ___syscall_rmdir,
  /** @export */ x: ___syscall_stat64,
  /** @export */ u: ___syscall_unlinkat,
  /** @export */ v: __abort_js,
  /** @export */ r: __embind_register_bigint,
  /** @export */ k: __embind_register_bool,
  ...
  /** @export */ p: __mktime_js,
  /** @export */ m: __mmap_js,
  /** @export */ n: __munmap_js,
  /** @export */ y: __tzset_js,
