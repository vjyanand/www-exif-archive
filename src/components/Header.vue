  ...
  <header class="bg-white border-b border-gray-300">
    <div class="container mx-auto max-w-5xl py-4 px-8 flex justify-between">
      ...
      <!-- <div class="hidden sm:flex items-center justify-between px-2">
       <nav>
          <RouterLink class="font-inter text:black hover:text-blue-600" to="/home">
            Home
          </RouterLink>
          <RouterLink class="font-inter text:black hover:text-blue-600" to="/blog">
            Blog
          </RouterLink>
          ...
          &nbsp;
          <a
            class="font-inter text:black hover:text-blue-600"
            href="mailto:help@pdftableconvert.com"
          >
            Contact
          </a>
        </nav> 
