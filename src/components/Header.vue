...
<template>
  <header class=" md:z-50 bg-white border-b border-gray-300">
    <div class="container mx-auto bg-fixed max-w-5xl py-4 px-8 flex justify-between">
      <RouterLink class="pr-1 flex items-center" to="/">
        ...
        <span class="font-playfair px-1 text-2xl font-bold">Exif Tool</span>
      </RouterLink>
      ...
      <button class="block sm:hidden p-1 m-1 rounded focus:outline-none hover:bg-gray-100 group" v-if="!isMobileMenuOpen"
      ...
      <div class="sm:hidden" role="dialog" aria-modal="true" v-if="isMobileMenuOpen">
        ...
        <div
          ...
          <div class="flex justify-end">
            <button class="-m-2.5 rounded-md p-2.5 text-gray-700" type="button" @click="closeMobileMenu">
          ...
          <div class="mt-6 flow-root -my-6 divide-y divide-gray-500/10 space-y-2 py-6">
            <RouterLink
            ...
            <a class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 hover:text-blue-700" href="mailto:help@pdftableconvert.com">
              Contact
            </a>
          </div>
        </div>
